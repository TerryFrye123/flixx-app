const global = {
  ...
  api: {
    apiKey: '7d088ee29f04a4add4c848c66cf9a073',
    ...
    <div class="details-top">
      ...
      <div>
        ...
        <a href="${movie.homepage}" 
           target="_blank" 
           class="btn">Visit Movie Homepage
         </a>
      </div>
  </div>
  <div class="details-bottom">
    ...
    <ul>
      <li><span class="text-secondary">
          Budget:</span> ${formatUSAmount(movie.budget)}</li>
      <li><span class="text-secondary">
          Revenue:</span> ${formatUSAmount(movie.revenue)}</li>
...
function formatUSAmount(amount) {
...
function displayPagination() {
  ...
  <div class="page-counter">Page ${global.search.page} 
    of ${global.search.totalPages}</div>
  `;
  ...
  results.forEach((nowPlaying) => {
    ...
    div.innerHTML = `          
      ...
      <h4 class="swiper-rating">
        <i class="fas fa-star text-secondary"></i> ${nowPlaying.vote_average} / 10
      </h4>
      `;
